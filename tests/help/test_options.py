...
│    --flag/--no-flag                         Set the flag (or not!).                              │
│    --password      TEXT                     Password to login with                               │
│ *  --loaded    -l  INTEGER RANGE [x>=0]     [env var: IS_LOADED] This option is loaded with      │
│                                             everything (assert preservation of order) [default:  │
...
│ *  --loaded   -l     This option is loaded with everything (assert preservation of order) [env   │
│                      var: IS_LOADED] [default: (Random number)] [required]                       │
│    --help     -h     Show help.                                                                  │
│    --version  -v     Show version.                                                               │
╰──────────────────────────────────────────────────────────────────────────────────────────────────╯
""")
