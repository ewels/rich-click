...
def cli() -> rich_click.RichCommand:
    cmd = load_command_from_module("tests.help.fixtures.context_settings")
    return cmd
...
def test_context_settings_help_for_click_8_1_plus(cli_runner: CliRunner, cli: rich_click.RichCommand) -> None:
 ...
 Note that in click < 8.1, '[default: False]' shows for "--help".                                   \n\
                                                                                                    \n\
╭─ Options ────────────────────────────────────────────────────────────────────────────────────────╮
│ --a        TEXT                     This works in all supported click versions. [default: show   │
│                                     me always]                                                   │
│ --b        TEXT                     This works in all supported click versions. [default: show   │
│                                     me always]                                                   │
