...
│                                                 RichHelpConfiguration() used to render the help  │
│                                                 text of the command. You can pass either a JSON  │
│                                                 directly, or a file prefixed with `@` (for       │
│                                                 example: '@rich_config.json'). Note that the     │
│                                                 --rich-config option is also used to render this │
│                                                 help text you're reading right now!              │
│ --output       -o  [html|svg|text]              Optionally render help text as HTML or SVG or    │
│                                                 plain text. By default, help text is rendered    │
│                                                 normally.                                        │
╰──────────────────────────────────────────────────────────────────────────────────────────────────╯
""")
