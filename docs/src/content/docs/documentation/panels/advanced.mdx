...
description: >-
  Advanced rich-click panel control: explicit panel ordering, custom column types, help section types, and subclassing RichPanel.
---

import { Code } from '@astrojs/starlight/components';
import panelsPanelOrderExplicitRaw from '@code_snippets/panels/panels_panel_order_explicit.py?raw';
import panelsPanelOrderExplicitOverrideRaw from '@code_snippets/panels/panels_panel_order_explicit_override.py?raw';
import panelsColumnTypesRaw from '@code_snippets/panels/panels_column_types.py?raw';
import panelsHelpSectionTypesRaw from '@code_snippets/panels/panels_help_section_types.py?raw';
import panelsSubclassRaw from '@code_snippets/panels/panels_subclass.py?raw';
...
<Code code={panelsPanelOrderExplicitRaw} lang="python" />
...
<Code code={panelsPanelOrderExplicitOverrideRaw} lang="python" />
...
<Code code={panelsColumnTypesRaw} lang="python" />
...
<Code code={panelsHelpSectionTypesRaw} lang="python" meta="{22-23}" />
...
<Code code={panelsSubclassRaw} lang="python" />
