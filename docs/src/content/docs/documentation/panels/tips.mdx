...
title: "Panels - Tips"
description: >-
  Practical advice for rich-click panels: where the --help option lands, controlling row order, and the mistakes that are easy to make.
---

import { Code, TabItem, Tabs } from '@astrojs/starlight/components';
import panelsHandlingHelpMistakeRaw from '@code_snippets/panels/panels_handling_help_mistake.py?raw';
import panelsHandlingHelpFix1Raw from '@code_snippets/panels/panels_handling_help_fix_1.py?raw';
import panelsHandlingHelpFix2Raw from '@code_snippets/panels/panels_handling_help_fix_2.py?raw';
import panelsRowOrderRaw from '@code_snippets/panels/panels_row_order.py?raw';
...
<Tabs>
<TabItem label="Mistake">

<Code code={panelsHandlingHelpMistakeRaw} lang="python" />
...
<TabItem label="Fix (method 1)">
<Code code={panelsHandlingHelpFix1Raw} lang="python" meta="{13}" />
...
<TabItem label="Fix (method 2)">
<Code code={panelsHandlingHelpFix2Raw} lang="python" meta="{12}" />
...
<Code code={panelsRowOrderRaw} lang="python" />
