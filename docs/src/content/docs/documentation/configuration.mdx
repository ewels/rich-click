...
title: "Configuration"
description: >-
  The two ways to configure rich-click: the rich_config decorator with RichHelpConfiguration, and the module-level global variables.
---

import { Code, TabItem, Tabs } from '@astrojs/starlight/components';
import richClickRaw from '@rich_click/rich_click.py?raw';
...
<Code code={richClickRaw.split('#!STARTCONFIG')[1].split('#!ENDCONFIG')[0].trim()} lang="python" />
