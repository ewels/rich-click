...
title: "Typer Support"
description: >-
  Experimental support for rendering Typer applications with rich-click via patch_typer(), and its version constraints.
---

import { Code } from '@astrojs/starlight/components';
import typerExampleRaw from '@code_snippets/typer_support/typer_example.py?raw';
...
<Code code={typerExampleRaw} lang="python" meta="{24-28}" />
...
{/* RICH-CODEX working_dir: docs/code_snippets/typer_support */}
