...
description: >-
  The four text_markup modes rich-click supports (Rich markup, Markdown, ANSI and plain), plus emoji, newline handling and help text styling.
---
...
{/* RICH-CODEX working_dir: docs/code_snippets/text_markup_and_formatting */}
