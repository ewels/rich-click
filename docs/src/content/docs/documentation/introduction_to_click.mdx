...
description: >-
  A short introduction to Click, the Python CLI framework that rich-click wraps: commands, options, arguments and groups.
---

import { Code } from '@astrojs/starlight/components';
import helloRaw from '@code_snippets/introduction_to_click/hello.py?raw';
import helloV2Raw from '@code_snippets/introduction_to_click/hello_v2.py?raw';
import helloV3Raw from '@code_snippets/introduction_to_click/hello_v3.py?raw';
...
<Code code={helloRaw} lang="python" title="docs/code_snippets/introduction_to_click/hello.py" />

You can run the file like normal, or you can run `--help` to render the function's docstring:

{/* RICH-CODEX working_dir: docs/code_snippets/introduction_to_click */}
...
<Code code={helloV2Raw} lang="python" title="docs/code_snippets/introduction_to_click/hello_v2.py" />
...
<Code code={helloV3Raw} lang="python" title="docs/code_snippets/introduction_to_click/hello_v3.py" />
