...
title: "Themes"
description: >-
  Ready-made rich-click themes, how to apply one as a developer, and how end users override it with the RICH_CLICK_THEME environment variable.
---

import { Code, TabItem, Tabs } from '@astrojs/starlight/components';
import cliRaw from '@code_snippets/themes/cli.py?raw';
