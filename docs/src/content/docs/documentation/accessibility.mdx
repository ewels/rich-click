...
title: "Accessibility"
description: >-
  Accessibility in rich-click CLIs for both users and developers: colourblind-safe palettes, disabling colour, and testing your own output.
---

import { Code, TabItem, Tabs } from '@astrojs/starlight/components';
import colorsRaw from '@code_snippets/accessibility/colors.py?raw';
...
<Code code={colorsRaw} lang="python" />
