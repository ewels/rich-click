...
description: >-
  The rich-click command line tool, which reformats the help output of any existing Click CLI without changing its code.
---
...
{/* RICH-CODEX working_dir: docs/code_snippets/rich_click_cli */}
