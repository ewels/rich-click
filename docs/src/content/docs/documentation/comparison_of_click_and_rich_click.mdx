...
description: >-
  What rich-click changes relative to Click, and what it leaves alone: the overridden decorators, the extra API surface, and the Click features that still work unmodified.
---
