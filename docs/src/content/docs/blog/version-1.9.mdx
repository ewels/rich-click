...
title: "v1.9 released!"
description: >-
  rich-click 1.9 adds themes, panels, IDE autocomplete, Typer support in the CLI tool, help text for arguments and command aliases.
...
import typerExampleRaw from '@code_snippets/rich_click_cli/typer_example.py?raw';
import typerExampleRawX from '@code_snippets/typer_support/typer_example.py?raw';
...
<Tabs syncKey="theme-example">
<TabItem label="nord-nu">
...
<Code code={typerExampleRaw} lang="python" />
...
<Code code={typerExampleRawX} lang="python" meta="{24-28}" />
