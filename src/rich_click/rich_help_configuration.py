...
class RichHelpConfiguration:
    ...
    # Default styles
    style_option: "StyleType" = field(default="bold cyan")
    ...
    style_metavar_append: "StyleType" = field(default="dim yellow")
    style_metavar_separator: "StyleType" = field(default="dim")
    style_header_text: "StyleType" = field(default="")
    style_epilog_text: "StyleType" = field(default="")
